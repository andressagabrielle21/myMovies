...
const MovieInfo = () => {
    ...
    return (
        <div className="flex justify-center items-center bg-black/50 md:p-10
            fixed max-md:absolute max-md:bottom-0 md:top-0 left-0 w-screen h-screen z-1000">
            <div className="flex flex-col bg-primary rounded-xl p-8 items-start max-md:items-center justify-center gap-3 mt-6 w-[60%] max-md:w-[90%] shadow-2xl shadow-indigo-500/40 overflow-auto">
                <div className="flex w-full items-center justify-between">
                    <h2 className="text-5xl font-bold text-white max-md:text-center">{movieInfo?.title}</h2>

                    <Link to={"/"} className="font-bold text-3xl text-white hover:text-indigo-600">X</Link>
                </div>
